...
define( function( require ) {
  ...
  function CellStructureModel() {
    ...
    //models
    var plantCellMagnifiedImage = new MagnifiedImage(plantCellImage, new Overlay(10, new Vector2(10,10)));
    var animalCellMagnifiedImage = new MagnifiedImage(animalCellImage, new Overlay(10, new Vector2(0,0)));
